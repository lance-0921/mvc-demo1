...
var $btn1 = (0, _jquery.default)('#btnAdd');
var $btn2 = (0, _jquery.default)('#btnReduce');
var $btn3 = (0, _jquery.default)('#btnMultiply');
var $btn4 = (0, _jquery.default)('#btnDivide');
var $number = (0, _jquery.default)('#number');
var n = localStorage.getItem('n'); //getItem() 作为 Storage 接口的方法，接受一个键名（key name）作为参数，并返回对应键名的值（key's value）

$number.text(n || 100);
$btn1.on('click', function () {
  var n = parseInt($number.text()); //parseInt把字符串 [ 参数 string 的值] 解析成整数
...
var $rec = (0, _jquery.default)('#app3 .rec');
...
var $trans = (0, _jquery.default)('#app4 .trans');
